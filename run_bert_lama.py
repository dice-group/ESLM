...
ARGUMENTS = argparse.Namespace(**PARAMETERS)
    ...
    for epoch in range(config["n_epochs"]):
        ...
        for eid in tqdm(train_data):
            ...
            for i, (sub_literal, pred_literal, obj_literal) in enumerate(literals):
                triple_sentence = [sub_literal, pred_literal, obj_literal]
                print("triple_sentence", triple_sentence)
                encoded_triple = encode(args, triple_sentence)
                print(encoded_triple)
